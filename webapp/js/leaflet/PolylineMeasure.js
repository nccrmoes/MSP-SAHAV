(function (factory) {
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
             ...
             * @default
             */
            tooltipTextFinish: 'Click to <b>finish line</b><br><br/>',
            tooltipTextDelete: 'Press SHIFT-key and click to <b>delete point</b>',
            tooltipTextMove: 'Click and drag to <b>move point</b><br/><br/>',
            tooltipTextResume: '<br/>Press ' + (isMacOS ? '⌘' : 'CTRL-key') + ' and click to <b>resume line</b><br/>',
